...
-- Προσώπου / Σώματος") επειδή στον πίνακα service_consents λείπουν οι στήλες
-- collected_by και consent_group που χρησιμοποιεί ο κώδικας τόσο για
-- αποθήκευση όσο και για ανάγνωση (ξεχωριστά ανά ομάδα: cleansing_poreover /
-- peelings_microneedling / oxygen_facetreatments). Αυτό το script τις
-- προσθέτει με ασφάλεια — δεν πειράζει καθόλου υπάρχουσες εγγραφές.
